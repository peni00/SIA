...
<head>
    ...
    <link rel='stylesheet' type='text/css' media='screen' href='css/Appointment2.css'>
   ...
   <div class="sidebar open">
    ...
    <div class="main-content">
        ...
        <div class="button-selection">
            ...
            <a href="http://18.136.105.108:81/SIA/Admin/Dashboard/Inventory-Dashboard.php"><Button class="appbtn">INVENTORY</Button></a>
        </div>
        <div>
