    ...
    <div class="main">
        <div class="sidebar">
            ...
            <ul class="sname">
                ...
                <a href="http://18.136.105.108/SIA/Admin/GYM/GYM/Appointment.php">
                    <li>APPOINTMENTS</li>
                </a>
                </a>
        ...
        <div class="container">
            ...
            <div class="ARCHIVE">
                <a href="http://18.136.105.108/SIA/Admin/GYM/GYM/Archives-Services.php"><button
                        class="serbtn1">SERVICE</button></a>
                <a href="#"><Button class="stabtn1">STAFF</Button></a>
                <a href="http://18.136.105.108/SIA/Admin/GYM/GYM/Archives-Appointment.php"><Button
