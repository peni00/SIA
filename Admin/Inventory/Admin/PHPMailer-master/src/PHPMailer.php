...
class PHPMailer
{
     ...
     * @var string
     */
    public $From = 'root@18.136.105.108';
     ...
     * Returns '18.136.105.108.localdomain' if unknown.
     *
     * @return string
     */
    protected function serverHostname()
    {
        ...
        if (!static::isValidHost($result)) {
            return '18.136.105.108.localdomain';
        }
